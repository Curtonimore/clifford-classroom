export default function LessonPlanGenerator() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-20 font-average">
      <h1 className="text-4xl text-brand-green font-bold mb-4">Lesson Plan Generator</h1>
      <p className="text-lg text-gray-700 mb-6">Generate lesson plans tailored to your needs.</p>
      ...
      <div className="border rounded p-4 bg-gray-50 text-gray-600">Generated lesson plan will appear here.</div>
    </main>
  );
} 