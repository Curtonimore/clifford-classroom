...
export default function Home() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 font-average">
      <h1 className="text-4xl font-bold text-brand-green mb-4">Real Tools for Real Teaching</h1>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 bg-white border p-6 rounded shadow hover:shadow-md transition flex flex-col justify-between">
          ...
          <Link href="/tools/lesson-planner" className="mt-auto bg-brand-green text-white px-4 py-2 rounded hover:bg-brand-green-dark text-center font-semibold">Preview Tool</Link>
        </div>
        {/* Quiz Builder Card */}
        <div className="flex-1 bg-white border p-6 rounded shadow hover:shadow-md transition flex flex-col justify-between">
          <div>
          ...
          <Link href="/tools/quiz-builder" className="mt-auto bg-brand-green text-white px-4 py-2 rounded hover:bg-brand-green-dark text-center font-semibold">Preview Tool</Link>
        </div>
        ...
        <div className="flex-1 bg-white border p-6 rounded shadow hover:shadow-md transition flex flex-col justify-between">
          ...
          <Link href="/tools/worksheet-maker" className="mt-auto bg-brand-green text-white px-4 py-2 rounded hover:bg-brand-green-dark text-center font-semibold">Preview Tool</Link>
        </div>
      </div>
    </main>
  );
